...
ALTER TABLE [dbo].[Proprietaire]
    ADD CONSTRAINT [FK_ProprietaireClient] FOREIGN KEY ([idProprietaire]) REFERENCES [dbo].[Client] ([IdClient]);
...
IF NOT EXISTS (SELECT OperationKey FROM [dbo].[__RefactorLog] WHERE OperationKey = '34148155-86c2-44c2-aacc-1872cd3e7cf5')
INSERT INTO [dbo].[__RefactorLog] (OperationKey) values ('34148155-86c2-44c2-aacc-1872cd3e7cf5')
...
INSERT INTO [Proprietaire]([idProprietaire]) 
VALUES (1)
